...
//access terumi api through color object GET ALL RESULTS
  getColors():Observable<Color[]>{
    return this.httpClient.get<Color[]>('http://api.tkusaka.com/palette_api.php?api_key=5b34ee3457dfa')
    .pipe(catchError(this.handleError));
  }

  getColor(id: Number):Observable<Color>{
    return this.httpClient.get<Color>('http://api.tkusaka.com/palette_api.php?api_key=5b34ee3457dfa&palette_id=' + id)
    .pipe(catchError(this.handleError));
  }
